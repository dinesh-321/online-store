...
export const CategoryList = () => {
  ...
  const handleEdit = async (product) => {
    try {
      const res = await axios.get(`/api/admindata/GetCategoryData/${product}`);
      const data = res.data;
      ...
      >
        ...
        <div className="flex flex-col gap-1 max-w-md">
          ...
          >
            ...
            {maincategoryList && categoryList.length > 0 ? (
  ...
  const deleteAirframe = async ({ deleteid }) => {
    ...
    const response = await axios.delete(
      `/api/admindata/dldCategory/${deleteid}`
    );
  ...
  return (
    <div className="no-scrollbar flex-1 h-[95vh] overflow-y-scroll flex flex-col justify-between">
      <div className="w-full md:p-10 p-4">
        <h2 className="pb-4 text-lg font-medium">Category List</h2>
