                    ...
                    <div className="col-md-4">
                        <div className="hot-deals position-relative rounded-16 bg-main-600 overflow-hidden p-28 z-1 text-center">
                            ...
                            <div className="hot-deals__thumb">
                                <img src="assets/images/thumbs/hotdealtoday1.jpg" alt="" width='250' />
                            </div>
                            ...
                            <Slider {...settings}>
                                <div>
                                    <div className="product-card h-100 p-8 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                                        ...
                                        >
                                            <img src="assets/images/thumbs/hotdealtoday2.jpg" alt="" />
                                        </Link>
                                ...
                                <div>
                                    <div className="product-card h-100 p-8 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                                        ...
                                        <Link
                                            ...
                                            className="product-card__thumb flex-center"
                                        >
                                            <img src="assets/images/thumbs/hotdealtoday3.jpg" alt="" />
                                        </Link>
                                        <div className="product-card__content p-sm-2">
                                            <h6 className="title text-lg fw-semibold mt-12 mb-8">
                                                <Link to="/product-details" className="link text-line-2">
                                ...
                                <div>
                                    <div className="product-card h-100 p-8 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                                        ...
                                        <Link
                                            ...
                                            className="product-card__thumb flex-center"
                                        >
                                            <img src="assets/images/thumbs/hotdealtoday4.jpg" alt="" />
                                        </Link>
                                        <div className="product-card__content p-sm-2">
                                            <h6 className="title text-lg fw-semibold mt-12 mb-8">
                                                <Link to="/product-details" className="link text-line-2">
                                ...
                                <div>
                                    <div className="product-card h-100 p-8 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                                        ...
                                        <Link
                                            ...
                                            className="product-card__thumb flex-center"
                                        >
                                            <img src="assets/images/thumbs/hotdealtoday5.jpg" alt="" />
                                        </Link>
                                        <div className="product-card__content p-sm-2">
                                            <h6 className="title text-lg fw-semibold mt-12 mb-8">
                                                <Link to="/product-details" className="link text-line-2">
                                ...
                                <div>
                                    <div className="product-card h-100 p-8 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                                        ...
                                        <Link
                                            ...
                                            className="product-card__thumb flex-center"
                                        >
                                            <img src="assets/images/thumbs/hotdealtoday6.jpg" alt="" />
                                        </Link>
                                        <div className="product-card__content p-sm-2">
                                            <h6 className="title text-lg fw-semibold mt-12 mb-8">
                                                <Link to="/product-details" className="link text-line-2">
