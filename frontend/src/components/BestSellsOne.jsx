                            ...
                            <div className="col-md-6">
                                <div className="product-card style-two h-100 p-8 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2 flex-align gap-16">
                                    <div className="">
                                        ...
                                        >
                                            <img src="assets/images/thumbs/bro1.jpg" alt="" />
                                        </Link>
                                ...
                                <div className="product-card style-two h-100 p-8 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2 flex-align gap-16">
                                    <div className="">
                                        ...
                                        <Link
                                            ...
                                            className="product-card__thumb flex-center"
                                        >
                                            <img src="assets/images/thumbs/bro2.jpg" alt="" />
                                        </Link>
                                    ...
                                    <div className="product-card__content">
                                        ...
                                        <h6 className="title text-lg fw-semibold mt-12 mb-8">
                                            <Link to="/product-details" className="link text-line-2">
                                                Taylor Farms Tomato Florets Vegetables
                                            </Link>
                                        </h6>
                                        <div className="flex-align gap-4">
                                            <span className="text-main-600 text-md d-flex">
                                ...
                                <div className="product-card style-two h-100 p-8 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2 flex-align gap-16">
                                    <div className="">
                                        ...
                                        <Link
                                            ...
                                            className="product-card__thumb flex-center"
                                        >
                                            <img src="assets/images/thumbs/bro3.jpg" alt="" />
                                        </Link>
                                    ...
                                    <div className="product-card__content">
                                        ...
                                        <h6 className="title text-lg fw-semibold mt-12 mb-8">
                                            <Link to="/product-details" className="link text-line-2">
                                                Taylor Farms Onion Florets Vegetables
                                            </Link>
                                        </h6>
                                        <div className="flex-align gap-4">
                                            <span className="text-main-600 text-md d-flex">
                                ...
                                <div className="product-card style-two h-100 p-8 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2 flex-align gap-16">
                                    <div className="">
                                        ...
                                        <Link
                                            ...
                                            className="product-card__thumb flex-center"
                                        >
                                            <img src="assets/images/thumbs/bro4.jpg" alt="" />
                                        </Link>
                                    ...
                                    <div className="product-card__content">
                                        ...
                                        <h6 className="title text-lg fw-semibold mt-12 mb-8">
                                            <Link to="/product-details" className="link text-line-2">
                                                Taylor Farms Carrot Florets Vegetables
                                            </Link>
                                        </h6>
                                        <div className="flex-align gap-4">
                                            <span className="text-main-600 text-md d-flex">
