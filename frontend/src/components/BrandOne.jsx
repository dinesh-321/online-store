                ...
                <div className="brand-inner bg-color-one p-24 rounded-16">
                    ...
                    <div className="brand-slider arrow-style-two">
                        <Slider {...settings}>
                            ...
                            <div className="brand-item">
                                <img src="assets/images/thumbs/20.jpg" alt="" />
                            </div>
                            <div className="brand-item">
                                <img src="assets/images/thumbs/21.jpg" alt="" />
                            </div>
                            <div className="brand-item">
                                <img src="assets/images/thumbs/22.jpg" alt="" />
                            </div>
                            <div className="brand-item">
                                <img src="assets/images/thumbs/23.jpg" alt="" />
                            </div>
                            <div className="brand-item">
                                <img src="assets/images/thumbs/24.jpg" alt="" />
                            </div>
                            <div className="brand-item">
                                <img src="assets/images/thumbs/25.jpg" alt="" />
                            </div>
                            <div className="brand-item">
